...
--
INSERT INTO `gapi_sale_types` (name) VALUES ('Garage Sale'), ('Yard Sale'), ('Moving Sale'), ('Estate Sale');
...
--
INSERT INTO `gapi_item_categories` (name) VALUES ('Furniture'), ('Electronics'), ('Clothing'), ('Toys'), ('Books'), ('Antiques'), ('Tools'), ('Home Goods');
...
CREATE TABLE `gapi_events` (
  ...
  FOREIGN KEY (`sale_type_id`) REFERENCES `gapi_sale_types`(`id`) ON DELETE SET NULL
);
...
VALUES
('a1b2c3d4-e5f6-7890-1234-567890abcdef', 'fedcba09-8765-4321-0987-654321fedcba', 'Huge Neighborhood Garage Sale', 'Lots of items for everyone! Furniture, kids toys, clothing, and more. Come find a treasure!', '123 Main St, Anytown, USA 12345', 40.7128, -74.0060, '2024-08-10 08:00:00', '2024-08-10 16:00:00', 1),
('b2c3d4e5-f6a7-8901-2345-67890abcdef1', '1fedcba0-9876-5432-1098-7654321fedcb', 'Moving Out - Everything Must Go!', 'We are moving across the country and selling everything. High-quality furniture, kitchen appliances, and tools.', '456 Oak Ave, Sometown, USA 54321', 34.0522, -118.2437, '2024-08-11 09:00:00', '2024-08-11 14:00:00', 3);
...
VALUES
(1, 1), -- Event 1 has Furniture
(1, 3), -- Event 1 has Clothing
(1, 4), -- Event 1 has Toys
(2, 1), -- Event 2 has Furniture
(2, 7), -- Event 2 has Tools
(2, 8); -- Event 2 has Home Goods

--
-- Insert Dummy Ratings (for event_id = 1)
--
INSERT INTO `gapi_event_ratings` (`event_id`, `rating_value`) VALUES (1, 5), (1, 4);

--
-- Insert Dummy Comments (for event_id = 2)
--
INSERT INTO `gapi_event_comments` (`event_id`, `comment_text`) VALUES (2, 'Are you selling any power tools?');
