...
# =================================================================
# This script runs before Apache starts. It rewrites api/config.php
# using the DB_* environment variables injected by docker-compose,
# so you don't need to hardcode credentials in the PHP file.
# =================================================================

set -e

CONFIG_FILE="/var/www/html/api/config.php"

echo "Configuring database connection from environment variables..."
...
echo "config.php written successfully."
