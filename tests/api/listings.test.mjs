...
import {owner,request,json,create,payload,fixtureId,deletedId,missingId} from '../support/client.mjs';
...
test('create, edit, soft delete and restore via HTTP',async()=>{
  ...
  await edit(404,json('PUT',changed));
...
test('malformed/missing input and unknown edit credentials fail',async()=>{
  ...
  await owner(missingId)(404);
  await owner(missingId)(404,json('PUT',payload));
  await owner(missingId)(404,{method:'DELETE'});
  await owner(missingId)(404,{method:'POST'},'/undelete');
});
