...
define('DB_HOST', getRuntimeSetting('DB_HOST') ?: 'localhost');
define('DB_PORT', getRuntimeSetting('DB_PORT') ?: '3306');
define('DB_USER', getRuntimeSetting('DB_USER'));
define('DB_PASSWORD', getRuntimeSetting('DB_PASSWORD'));
define('DB_NAME', getRuntimeSetting('DB_NAME'));
